...
curl -d '{"name": "fooac", "description":"bla"}' -H "Content-Type: application/json" -X POST localhost:8083/accounts/pools/1/users/1

curl -d '{"name": "bar", "description":"baz"}' -H "Content-Type: application/json" -X POST localhost:8083/users
curl -d '{"name": "barac", "description":"bla"}' -H "Content-Type: application/json" -X POST localhost:8083/accounts/pools/1/users/2
